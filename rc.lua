...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "m", function () awful.util.spawn("nautilus /home/aclough") end),
    awful.key({ modkey,           }, "n", function () awful.util.spawn("banshee") end),
    awful.key({ modkey,           }, "p", function () awful.util.spawn( "dmenu_run") end),
    awful.key({ modkey,           }, "v", function () awful.util.spawn( "emacs") end)
)
...
for i = 1, keynumber do
    globalkeys = awful.util.table.join(globalkeys,
        ...
        awful.key({ modkey, "Control", altkey  }, "#" .. i + 9,
                  function ()
                      if client.focus and tags[client.focus.screen][i] then
                          awful.client.toggletag(tags[client.focus.screen][i])
                      end
